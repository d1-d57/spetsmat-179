...
**`zhurnal/2026-09-02_spetsmat-bot/HANDOFF-2026-09-12.md`** (Хэндофф в сессию 2026-09-12)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_adres-bazy.md`** (у базы появляется АДРЕС вместо имени: отказ вне сервера, метка внутри базы, одна дверь на запись, ни одного файла базы в репозитории)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_kabinet-plitki.md`** (кабинет: плитки сворачиваются, пять колонок, вкладки четвертей, будущие пустые; кондуит за занятие кнопкой)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_konduit-galochki-i-podskazki.md`** (кондуит: галочка в клетку обязательных, рабочие подсказки инициалов, номер закрытого листка у галочки Весь год)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_otsutstvie-prepodavatelya.md`** (преподавателя нет с даты по дату: отметить, сохранить, показать в журнале, убрать из выбора принимающих на все дни периода)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_sloi-postoyannoe-v-den.md`** (почему постоянное не видно в дне и кнопка применить постоянное)
...
**`zhurnal/2026-09-02_spetsmat-bot/kod_zhurnal-setka.md`** (журнал: убрать прозу, узкие колонки на все занятия четверти вперёд, вкладки четвертей, клетка открывает кондуит)
