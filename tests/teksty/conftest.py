...
#   Живая точка вызова — сам `pytest`: он находит `conftest.py` по имени и
#   зовёт `pytest_terminal_summary` каждым прогоном. Упоминания в хуке или шаге
#   сборки у такого файла не бывает по устройству, отсюда маркер.
