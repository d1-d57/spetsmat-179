...
#v-В .dva,#v-Д .dva,#v-Н .dva{grid-template-columns:minmax(0,.84fr) minmax(0,1.16fr)}
...
#s-rasp .para .komu,#v-shk .para .komu{flex:1 1 auto;min-width:0;margin-left:0}
#s-rasp .para .komu .dv-den{flex:1 1 8rem;min-width:0}
#s-rasp .para .komu .dv-den:not(:has(.org)){flex:1 1 12rem}
#s-rasp .para .komu .dv-den .pr-sel{max-width:100%}
...
#s-rasp .para .komu .dv-pn,#s-rasp .para .komu .dv-cht{flex:1 1 9.6rem;min-width:0}
...
#s-rasp .para .kl-kol{flex:0 0 1.6rem}
#s-rasp .para .gr-sel,#s-rasp .para .grd-sel{width:3.45rem;flex:0 0 3.45rem}
#s-rasp .para .otsut{font-size:.7rem;padding:.1em .35em}
...
def vid_vse(kt):
    ...
    imya_style = ('<style>:root{--imya-w:calc(%dch * 1.13 + .6rem)}</style>'
                  % shirina_imeni_ch(kt))
