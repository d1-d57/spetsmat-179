...
ZAGOLOVOK_SCH_GOD = ('<th class="sch" title="сдано обязательных задач этого разреза '
                     ...
                     'нет: закрыты все обязательные задачи года или хотя бы один листок '
                     'целиком, и рядом с галочкой написано какой">\u041e\u0431\u044f\u0437.</th>')
...
def _obzor(na_uchyote, listki, zadachi, sostoyaniya, chuzhoj, prinimayushchie, imya="vse") -> str:
    ...
    for u in na_uchyote:
        ...
        if schyot.zakryl:
            ...
            podskazka = "долгов нет: закрыл листок %s целиком" % listok_celikom
            if schyot.vsego:
