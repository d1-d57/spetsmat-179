...
.kl-kol{flex:0 0 2.3rem;min-width:0;color:var(--muted);font-family:var(--sans);
  font-size:.85rem;text-align:center;align-self:baseline}
...
.para:has(.dv-den) .kto{flex:0 0 var(--imya-w,16ch);min-width:0}
...
.kol-pr .para{padding:1.7rem 1.1rem;margin-bottom:.6rem;background:var(--panel);
