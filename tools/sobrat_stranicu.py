...
.glav-setka{{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(0,1fr);
  gap:2.5rem 4rem;margin-top:auto;padding:2rem 0 0;align-items:end}}
...
.vedut td{{border:none;padding:.4rem 0;vertical-align:baseline}}
.vedut .predmet{{color:var(--muted);padding-right:2.4rem;white-space:nowrap;
  font-family:var(--sans);font-size:clamp(1.15rem,1.35vw,1.5rem)}}
