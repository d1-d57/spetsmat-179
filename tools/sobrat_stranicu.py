...
.glav-imya{{font-size:clamp(2.4rem,5.4vw,4.6rem);font-weight:600;letter-spacing:-.03em;
...
.glav-setka{{display:grid;grid-template-columns:minmax(0,1.5fr) minmax(0,.85fr);
  gap:2.5rem 4rem;margin-top:auto;padding:2.5rem 0 1rem;align-items:end}}
