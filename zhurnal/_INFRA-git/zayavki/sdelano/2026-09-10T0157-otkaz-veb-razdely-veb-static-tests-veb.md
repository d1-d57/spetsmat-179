ЗАЯВКА: 2026-09-10T01:57 · автор: host · арка: не названа
СРОЧНОСТЬ: blokiruet
РОД: git-operaciya

ОТКАЗ GIT-ОПЕРАЦИИ: коммит зоны veb/razdely, veb/static, tests/veb
КОМАНДА: git_zona.py commit --zone veb/razdely, veb/static, tests/veb -m …
КОД ВОЗВРАТА: 1
ОШИБКА: [проверка индекса на чужое вне контракта зоны] rc=1: застейджено 1 путей вне зоны `veb/razdely, veb/static, tests/veb`: tools/gejt_verstki.py
...
ПОПЫТКА: 2026-09-10T01:57 · тот же отказ на той же операции, попытка 2 — новой заявки НЕ завожу
