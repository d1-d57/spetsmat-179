# Канал исполнителя — S3-glavnaya-i-listki (один заход до конца)
...
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/orkestr.py /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot/zhurnal/2026-09-02_spetsmat-bot \
  ...
  --zahody kod_S3-glavnaya-i-listki.md
```
...
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/git_zona.py worktree add S3-glavnaya-i-listki --branch zahod/S3-glavnaya-i-listki && cd /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S3-glavnaya-i-listki && python3 /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot/_generator/tools/orkestr.py zhurnal/2026-09-02_spetsmat-bot --rezhim progon --dvizhok opencode --rod instrumenty --model openrouter/poolside/laguna-s-2.1:free --zahody kod_S3-glavnaya-i-listki.md < /dev/null 2>&1 | tee /tmp/zahod-S3-glavnaya-i-listki.log
...
```
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/bootstrap_zahod.py --zadanie-subagentu --zone veb/templates/ --zone veb/static/ --kommitit 'veb/templates/ veb/static/ — отдельным коммитом на каждую часть задачи' --zakryt 'ветку zahod/S3-glavnaya-i-listki влить самому последним ходом'
```
...
- `cd /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S3-glavnaya-i-listki` — рабочая папка ДЛЯ КОДА. Ветку НЕ переключай: `zahod/S3-glavnaya-i-listki` в ней уже стоит.
- Проверить, что на месте: `git rev-parse --abbrev-ref HEAD` → должно быть `zahod/S3-glavnaya-i-listki`.
...
```
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/git_zona.py vlit-v-osnovnuyu zahod/S3-glavnaya-i-listki --zone "veb/templates/" --zone "veb/static/" \
...
виден»: прогон изменённого механизма из `/Users/ivanyakovlev/Documents/GitHub/spetsmat-bot`, НЕ из рабочей папки `/Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S3-glavnaya-i-listki` плюс `grep` по ЖИВОМУ файлу,
...
**ВЕТКА РАБОТЫ:** `zahod/S3-glavnaya-i-listki`
