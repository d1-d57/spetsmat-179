...
102 passed in 5.11s                                  rc=0

$ python3 -m pytest -q
926 passed, 13 skipped in 58.72s                     rc=0     (требовалось 916+ и 0 failed)
```
