...
06:36 · круг 25 · ЗАКРЫТИЕ · запущено: — · ПРИНЯТО: ДВЕНАДЦАТЬ ИЗ ДВЕНАДЦАТИ · доработка: нет · без вердикта: 0 · main ЗЕЛЁНЫЙ 1252/1044, упавших 17 как на входе · ВЫКАЧЕНО до P12, четыре страницы боевого по 200 · НЕ В GIT: 0 · вопросов владельцу: 3 · фаза знания BORN 20 CLOSED 20 CARRIED 0 · STATUS: CLOSED, линтер зелёный
---
