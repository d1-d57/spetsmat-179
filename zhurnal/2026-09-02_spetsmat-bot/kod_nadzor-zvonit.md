...
> **Модель: openrouter/minimax/minimax-m3:free** — порог и звонок — механика двух скриптов, суждения нет.
...
```
Модель: openrouter/minimax/minimax-m3:free — см. обоснование в шапке захода, §0.
