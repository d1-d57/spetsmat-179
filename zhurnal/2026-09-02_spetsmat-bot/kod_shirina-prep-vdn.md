...
> **Модель: openrouter/minimax/minimax-m2.7:free** — одно правило CSS в одном файле, границы названы владельцем жёстко — суждения здесь нет, есть точное указание.
...
```
Модель: openrouter/minimax/minimax-m2.7:free — см. обоснование в шапке захода, §0.
