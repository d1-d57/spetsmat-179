...
**ВЕРДИКТ:** принято — вкладка История занятий: `core/services/istoria_poseshchenij.py`, `veb/razdely/istoria_zanyatij.py`, `tests/sessions` 29 passed. Гейт вёрстки после её появления вырос с 235 до 266 осмотренных элементов кондуита и остался по нулям. Заход честно назвал границу прав: свою ветку влил и вывез, main не тронул и подал заявку
