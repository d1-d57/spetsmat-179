...
> **Модель: openrouter/z-ai/glm-5.2:free** — чистая механика: два грепа с заменой и довоз трёх документов в git — суждения здесь нет вовсе.
...
```
Модель: openrouter/z-ai/glm-5.2:free — см. обоснование в шапке захода, §0.
