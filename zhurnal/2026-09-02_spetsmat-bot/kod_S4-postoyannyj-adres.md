# Канал исполнителя — S4-postoyannyj-adres (один заход до конца)
...
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/orkestr.py /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot/zhurnal/2026-09-02_spetsmat-bot \
  ...
  --zahody kod_S4-postoyannyj-adres.md
```
...
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/git_zona.py worktree add S4-postoyannyj-adres --branch zahod/S4-postoyannyj-adres && cd /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S4-postoyannyj-adres && python3 /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot/_generator/tools/orkestr.py zhurnal/2026-09-02_spetsmat-bot --rezhim progon --dvizhok opencode --rod instrumenty --model openrouter/nvidia/nemotron-3-super-120b-a12b:free --zahody kod_S4-postoyannyj-adres.md < /dev/null 2>&1 | tee /tmp/zahod-S4-postoyannyj-adres.log
...
```
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/bootstrap_zahod.py --zadanie-subagentu --zone deploy/ --zone infra/ --zone ops/ --kommitit 'deploy/ infra/ ops/ — отдельным коммитом на каждую часть задачи' --zakryt 'ветку zahod/S4-postoyannyj-adres влить самому последним ходом'
```
...
- `cd /Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S4-postoyannyj-adres` — рабочая папка ДЛЯ КОДА. Ветку НЕ переключай: `zahod/S4-postoyannyj-adres` в ней уже стоит.
- Проверить, что на месте: `git rev-parse --abbrev-ref HEAD` → должно быть `zahod/S4-postoyannyj-adres`.
...
```
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/git_zona.py vlit-v-osnovnuyu zahod/S4-postoyannyj-adres --zone "deploy/" --zone "infra/" --zone "ops/" \
...
виден»: прогон изменённого механизма из `/Users/ivanyakovlev/Documents/GitHub/spetsmat-bot`, НЕ из рабочей папки `/Users/ivanyakovlev/Documents/GitHub/spetsmat-bot-wt/S4-postoyannyj-adres` плюс `grep` по ЖИВОМУ файлу,
...
**ВЕТКА РАБОТЫ:** `zahod/S4-postoyannyj-adres`
