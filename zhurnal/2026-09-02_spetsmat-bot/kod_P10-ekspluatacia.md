...
git --no-optional-locks commit -m "<зона>: <что сделано>" -- deploy/ ops/ tests/ops/   # отсекает всё чужое
...
```
python3 /Users/ivanyakovlev/Documents/GitHub/disciplina/_generator/tools/git_zona.py vlit-v-osnovnuyu zahod/P10-ekspluatacia --zone <своя зона> \
