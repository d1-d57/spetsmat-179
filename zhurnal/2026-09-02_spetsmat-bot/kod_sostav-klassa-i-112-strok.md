...
🔴 НОЧНОЕ ПРОЧТЕНИЕ БЫЛО НЕВЕРНЫМ, И ЭТО ГЛАВНОЕ, ЧТО ТЕБЕ НАДО ЗНАТЬ. Ночью считали «в enrollment 56 строк на 56 детей — значит каждый закреплён». Замер, снятый при сборке волны и ПЕРЕПРОВЕРЕННЫЙ оркестратором в 17:20, говорит другое:
  ...
  строк 56 · РАЗНЫХ детей 53 · у 50 детей ПО ОДНОЙ строке · у 3 ПО ДВЕ · у 3 НЕТ НИ ОДНОЙ.
  50 + 3 + 3 = 56, сходится.
...
Достроить enrollment до двух строк на ребёнка. Не забудь троих, у кого нет ни одной строки: им нужны ОБЕ. Прогон ДВАЖДЫ подряд НЕ ПЛОДИТ дублей — это критерий. Правило выбора второго слота и преподавателя назови в отчёте явно; нет данных для осмысленного выбора — ставь заглушку и НАЗОВИ её заглушкой, а не выдавай за распределение.
