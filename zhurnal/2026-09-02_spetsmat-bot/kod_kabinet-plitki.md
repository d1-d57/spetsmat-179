...
позиция волны; вливать чужую недоделанную работу нельзя.
🔴 **ЧИСЛО ЗДЕСЬ ДВИЖЕТСЯ, И ЭТО СВОЙСТВО ВОЛНЫ, А НЕ РАСХОЖДЕНИЕ ОТЧЁТА.** За мой прогон
оно было 0 (снимок входа), 4, 2 и 3 — соседние позиции заводят и вливают свои ветки
параллельно со мной, в том же репозитории. Приёмка получит СВОЁ число, и оно снова будет
другим. Проверяемое утверждение одно, и оно от времени не зависит: **МОИХ невлитых
ноль** — `git branch --merged main` называет `zahod/kabinet-plitki`; всё остальное в
списке помечено `+`, то есть занято чужим worktree. (Третья, `zahod/konduit-
